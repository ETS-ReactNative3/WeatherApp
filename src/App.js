...
class App extends Component {
  ...
  setCity(city) {
   ...
   _getWeatherInfo = (city) => {
     ...
     fetch(`https://api.openweathermap.org/data/2.5/weather?q=${query}&units=metric&appid=50a34e070dd5c09a99554b57ab7ea7e2`)
   ...
   fetchWeather = (city) => {
      ...
      fetch(`https://api.openweathermap.org/data/2.5/forecast/daily?q=${query},us&units=metric&cnt=7&appid=50a34e070dd5c09a99554b57ab7ea7e2`)
      .then( function(response) {
        return response;
      })
      .then( function(response) {
